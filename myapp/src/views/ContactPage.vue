        ...
        <form action="#" class="space-y-8">
          <div>
            ...
            <input
              type="email"
              id="email"
              class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 block w-full p-2.5"
          ...
          <div class="flex justify-center">
            <Button
              type="submit"
              class="py-3 px-5 text-sm font-medium text-center focus:ring-4 focus:outline-none focus:ring-primary-300"
            >
              Send message
            </Button>
          </div>
              ...
              >
                <div class="flex items-start">
                  ...
                  <div class="grow ml-6">
                    ...
                    <p class="text-gray-500">anlecntt.0905@gmail.com</p>
