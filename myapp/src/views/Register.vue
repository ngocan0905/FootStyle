<template>
  <div
    class="uppercase flex flex-row-reverse h-screen justify-center items-center m-[0,auto] w-[90%] md:w-full bg-gradient-to-r from-gray-50 to-gray-200"
  >
    <form
      action=""
      ...
      <div class="my-4">
        <div class="flex">
          <input
            ...
            class="pl-10 bg-gray-200 rounded-lg leading-tight focus:bg-inherit focus:border-inherit py-2 text-gray-900 placeholder:text-gray-900"
            v-model="name"
          />
          <UserCircleIcon
